      ...
      <div className="max-w-7xl mx-auto px-6 md:px-20 lg:px-24 mb-16 relative z-10">
        ...
        >
          ...
          <div className="absolute bottom-8 left-8 right-8 flex flex-col md:flex-row items-start md:items-end justify-between gap-4">
            ...
            <span className="px-3.5 py-1.5 rounded-full border border-white/20 bg-[var(--color-surface)] text-[9px] font-black text-[var(--color-text-primary)]/80 uppercase tracking-widest backdrop-blur-md">
              Gurage, Ethiopia
            </span>
          </div>
        </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 divide-x divide-y md:divide-y-0 divide-white/5">
            {stats.map((stat, i) => (
              ...
              >
                ...
                <p className="text-[var(--color-text-primary)]/40 font-sans text-[9px] text-center leading-snug whitespace-pre-line tracking-[0.18em] uppercase group-hover:text-[var(--color-text-primary)]/60 transition-colors duration-300">
                  {stat.label}
                </p>
              </motion.div>
            ))}
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-20 lg:px-24 py-16 md:py-24 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-[var(--color-bg-primary)]/40 group-hover:bg-[var(--color-bg-primary)]/25 transition-all duration-700" />
          ...
          >
            ...
            <p className="text-[var(--color-text-primary)]/50 font-sans text-xs md:text-sm leading-relaxed max-w-md">
