...
export function GetInvolved() {
  return (
    <section
      id="get-involved"
      className="w-full bg-[var(--color-bg-secondary)] relative overflow-hidden select-none border-t border-[var(--color-border)] grid-bg"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-20 lg:px-24 pt-24 md:pt-32 pb-12 md:pb-16 border-b border-[var(--color-border)]">
        <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between gap-6">
          ...
          >
            Together, we can build a future where every child in the Gurage Zone
              ...
              <div className="relative z-10 mt-16">
                <h3
                  className={`font-sans font-black tracking-tight mb-3 transition-colors duration-300 ${
                    action.featured
                      ? "text-deep-forest"
                      : "text-[var(--color-text-primary)] group-hover:text-lime"
                  }`}
      ...
      <footer className="relative z-10 w-full border-t border-[var(--color-border)] py-8 md:py-10 bg-[var(--color-bg-primary)]/40 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 md:px-20 lg:px-24 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p
                className="font-sans text-[11px] font-bold tracking-wide"
                style={{ color: "var(--logo-contrast)" }}
              >
                የምስጋና በጎ አድራጎት ድርጅት
              </p>
              <p
          ...
          <div
            className="flex flex-col md:flex-row items-center gap-4 md:gap-8 font-sans text-[10px] tracking-wider font-semibold"
          ...
          <div className="flex items-center gap-3">
            {[
              ...
              { Icon: Instagram, label: "Check out our Instagram page" },
            ].map(({ Icon, label }, i) => (
              <a
                key={i}
                href="#"
                aria-label={label}
                className="w-9 h-9 rounded-full flex items-center justify-center transition-all duration-300 hover:border-[var(--color-lime)] hover:text-[var(--color-lime)] focus-visible:ring-2 focus-visible:ring-[var(--color-lime)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-bg-primary)] outline-none"
                style={{
