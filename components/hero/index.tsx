          ...
          <div className="flex-1 flex flex-col justify-center px-6 pt-24 pb-4">
            ...
            >
              ...
              <div className="flex items-center gap-4 mt-2">
                ...
                <button className="btn-ghost group flex items-center gap-2 text-[var(--color-text-muted)] text-[12px] font-semibold hover:text-[var(--color-text-primary)] transition-colors border-none p-0">
                  <div className="w-8 h-8 rounded-full border border-[var(--color-border)] flex items-center justify-center group-hover:border-lime">
                    <svg width="10" height="12" viewBox="0 0 10 12" fill="currentColor" aria-hidden="true" className="group-hover:text-lime">
      ...
      <div className="absolute bottom-24 md:bottom-20 left-6 md:left-10 lg:left-14 flex items-center gap-2" style={{ zIndex: 4 }}>
        {slides.map((_, i) => (
          <button
            ...
            } focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-lime)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-bg-primary)]`}
          />
        ))}
      </div>
