          ...
          <div className="flex-1 flex flex-col justify-center px-6 pt-24 pb-4">
            ...
            >
              ...
              <div className="flex items-center gap-4 mt-2">
                <button className="px-5 py-2.5 bg-lime text-deep-forest font-black text-[12px] rounded-full hover:bg-lime-light transition-all shadow-lg shadow-lime/25 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-lime)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-bg-primary)]">
                  Our Mission →
                </button>
                <button className="flex items-center gap-2 text-[var(--color-text-muted)] text-[12px] font-semibold hover:text-[var(--color-text-primary)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-lime)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-bg-primary)] rounded-full pr-3">
      ...
      <div className="absolute bottom-24 md:bottom-20 left-6 md:left-10 lg:left-14 flex items-center gap-2" style={{ zIndex: 4 }}>
        {slides.map((_, i) => (
          <button
            ...
            className={`rounded-full transition-all duration-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-lime)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-bg-primary)] ${
              i === current
                ? 'w-8 h-1.5 bg-lime'
