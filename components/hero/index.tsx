          ...
          <div className="flex-1 flex flex-col justify-center px-6 pt-24 pb-4">
            ...
            >
              ...
              <div className="flex items-center gap-4 mt-2">
                <button aria-label="Learn about our mission" className="px-5 py-2.5 bg-lime text-deep-forest font-black text-[12px] rounded-full hover:bg-lime-light transition-all shadow-lg shadow-lime/25 focus-visible:ring-2 focus-visible:ring-[var(--color-lime)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-bg-primary)] outline-none">
                  Our Mission →
                </button>
                <button aria-label="Watch our story video" className="flex items-center gap-2 text-[var(--color-text-muted)] text-[12px] font-semibold hover:text-[var(--color-text-primary)] transition-colors focus-visible:ring-2 focus-visible:ring-[var(--color-lime)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-bg-primary)] rounded-full px-2 py-1 -ml-2 outline-none">
