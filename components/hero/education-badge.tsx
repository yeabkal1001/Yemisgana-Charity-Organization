  ...
  return (
    <div className="hidden md:flex flex-col items-center absolute bottom-20 right-8 lg:right-14 z-30">
      ...
      <div className="flex flex-col items-center gap-1 mt-4">
        ...
        <p className="text-[var(--color-text-muted)] text-[9px] font-semibold tracking-[0.15em] uppercase">To Explore</p>
        <div className="relative w-[2px] h-6 mt-1 overflow-hidden rounded-full" style={{ background: 'var(--color-surface)' }}>
