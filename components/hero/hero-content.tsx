    ...
    <div className="absolute inset-0 flex items-center pt-20 pb-28 px-6 md:px-10 lg:px-14">
      ...
      >
        ...
        <motion.div variants={item} className="flex items-center gap-5 mt-2">
          <button className="btn-primary" aria-label="Learn about our mission">
            Our Mission →
          </button>
          <button className="btn-ghost flex items-center gap-2.5 font-sans" aria-label="Watch our story video">
