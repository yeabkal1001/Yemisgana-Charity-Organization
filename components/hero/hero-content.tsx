    ...
    <div className="absolute inset-0 flex items-center pt-20 pb-28 px-6 md:px-10 lg:px-14">
      ...
      >
        ...
        <motion.div variants={item} className="flex items-center gap-5 mt-2">
          ...
          <button className="btn-ghost flex items-center gap-2.5 font-sans group">
            <div className="w-8 h-8 rounded-full border border-[var(--color-border)] group-hover:border-lime flex items-center justify-center transition-colors" aria-hidden="true">
