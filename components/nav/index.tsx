        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 md:px-10 lg:px-12">
            ...
            {navLinks.map((link) => {
              ...
              return (
                <a
                  key={link.label}
                  href={link.href}
                  className={`relative text-[13px] font-semibold tracking-wider uppercase transition-colors duration-300 py-1.5 px-0.5 group focus-visible:ring-2 focus-visible:ring-lime focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-bg-primary)] ${
          ...
          <div className="flex items-center gap-4">
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="hidden sm:flex items-center gap-2 px-5 py-2.5 bg-lime text-deep-forest font-black text-[12px] uppercase tracking-wider rounded-full hover:bg-lime-light transition-all duration-300 shadow-[0_4px_20px_rgba(var(--color-lime-rgb),0.25)] hover:shadow-[0_4px_25px_rgba(var(--color-lime-rgb),0.4)] focus-visible:ring-2 focus-visible:ring-lime focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-bg-primary)]"
            >
            ...
            <button
              ...
              title="Toggle theme"
              className="hidden sm:inline-flex w-10 h-10 rounded-full border border-[var(--color-border)] bg-[var(--color-surface)] backdrop-blur-sm flex items-center justify-center text-[var(--color-text-primary)] hover:border-[var(--color-lime)] hover:bg-[var(--color-surface-hover)] transition-all duration-300 focus-visible:ring-2 focus-visible:ring-lime focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-bg-primary)]"
            >
            ...
            <button
              ...
              className="lg:hidden w-10 h-10 rounded-full border flex items-center justify-center transition-all duration-300 cursor-pointer focus-visible:ring-2 focus-visible:ring-lime focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-bg-primary)]"
          ...
          >
            ...
            <div className="flex items-center justify-between mb-16 max-w-7xl mx-auto w-full">
              ...
              <button
                ...
                className="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 cursor-pointer focus-visible:ring-2 focus-visible:ring-lime focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-bg-primary)]"
              ...
              {[...navLinks, { label: 'Get Involved', href: '#get-involved' }].map((link, i) => {
                ...
                return (
                  <motion.a
                    ...
                    className={`font-black tracking-tight leading-none uppercase transition-all duration-300 flex items-center gap-4 group focus-visible:ring-2 focus-visible:ring-lime focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-bg-primary)] ${
            ...
            <div className="pt-8 border-t flex items-center justify-between max-w-7xl mx-auto w-full" style={{ borderColor: 'var(--color-border)' }}>
              ...
              <a
                href="#get-involved"
                onClick={() => setMenuOpen(false)}
                className="px-6 py-3 bg-lime text-deep-forest font-bold text-[12px] uppercase tracking-wider rounded-full hover:bg-lime-light transition-all duration-300 shadow-[0_4px_15px_rgba(var(--color-lime-rgb),0.2)] focus-visible:ring-2 focus-visible:ring-lime focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-bg-primary)]"
              >
                Donate Now →
              </a>
            </div>
