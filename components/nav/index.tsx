        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 md:px-10 lg:px-12">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              title="Toggle theme"
              className="hidden sm:inline-flex w-10 h-10 rounded-full border border-[var(--color-border)] bg-[var(--color-surface)] backdrop-blur-sm flex items-center justify-center text-[var(--color-text-primary)] hover:border-[var(--color-lime)] hover:bg-[var(--color-surface-hover)] transition-all duration-300 focus-visible:ring-2 focus-visible:ring-lime focus-visible:ring-offset-2 focus-visible:ring-offset-deep-forest focus:outline-none"
            >
            ...
            <button
              ...
              className="lg:hidden w-10 h-10 rounded-full border flex items-center justify-center transition-all duration-300 cursor-pointer focus-visible:ring-2 focus-visible:ring-lime focus-visible:ring-offset-2 focus-visible:ring-offset-deep-forest focus:outline-none"
          ...
          >
            ...
            <div className="flex items-center justify-between mb-16 max-w-7xl mx-auto w-full">
              ...
              <button
                ...
                className="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 cursor-pointer focus-visible:ring-2 focus-visible:ring-lime focus-visible:ring-offset-2 focus-visible:ring-offset-deep-forest focus:outline-none"
