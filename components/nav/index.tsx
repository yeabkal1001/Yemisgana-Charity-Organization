    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 md:px-10 lg:px-12">
          ...
          {/* Logo */}
          <a href="#" className="flex items-center gap-3 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-lime)] focus-visible:ring-offset-4 focus-visible:ring-offset-[var(--color-bg-primary)] rounded-full">
              ...
              {[...navLinks, { label: 'Get Involved', href: '#get-involved' }].map((link, i) => {
                ...
                return (
                  <motion.a
                    ...
                    className={`font-black tracking-tight leading-none uppercase transition-all duration-300 flex items-center gap-4 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-lime)] focus-visible:ring-offset-4 focus-visible:ring-offset-[var(--color-bg-primary)] rounded-sm ${
