          ...
          {pillars.map((pillar, idx) => {
            ...
            return (
              <motion.div
                ...
                tabIndex={0}
                className={`relative rounded-3xl overflow-hidden min-h-[500px] flex flex-col justify-end p-8 border transition-all duration-700 ease-out cursor-pointer group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-lime)] focus-visible:ring-offset-4 focus-visible:ring-offset-[var(--color-bg-primary)] ${
                  isHovered 
